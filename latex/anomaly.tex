...
Fortunately, since we use the Public Transportation System (PTS) of an urbanized city, we are able to tally the detected anomalies with the tweets of the city's residents. We use the Twitter data set that was formerly used to analyze political sentiments in Hoang and Lim \cite{Hoang2012}, to perform a qualitative comparison of our detected anomalies with the tweets that comment on the traffic conditions. %The  The PTS is used by most residents of the city, which generates a lot of political discussions in the social media space.
...
\begin{table*}[htb]
	...
	\begin{tabular}{|r|p{5.5cm}|p{8.1cm}|p{2.1cm}|}
		...
		%10 & \emph{No longer accessible} & Slow-moving traffic now on roads that don't usually get jammed up. All because of the recent MRT breakdown. Running late for my appointment! & 2011-12-18 10:57:30 \\
		\hline
	\end{tabular}
\end{table*}
