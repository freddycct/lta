...
\begin{figure}[htb]
	\centering
	\subfloat[Histogram at the start node of an information-flow route]{
		\includegraphics[width=3.5in]{7_start}
		\label{fig:7_start}
	}\\
	\subfloat[Histogram at the end node of an information-flow route]{
